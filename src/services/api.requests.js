...
async function getJson() {
  const url = `https://api.hgbrasil.com/finance?key=${API_KEY}`;
  ...
  let bolsas_de_valores = {ibovespa, nasdaq, cac, nikkei}
  ...
  let corretoras_de_bitcoin = {blockchain, coinbase, bistamp, foxbit, mercado_bitcoin, xdex}
